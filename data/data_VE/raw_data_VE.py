...
def def_data_VE():
    return pd.read_csv("Projet/data/data_VE/voitures-par-commune-par-energie.csv", sep=";")
...
data["DATE_ARRETE"]=pd.to_datetime(data["DATE_ARRETE"], format="%Y-%m-%d")
data["Annee"]=data["DATE_ARRETE"].dt.year

data_VE_annee_dep=data.loc[data.groupby(["LIBGEO", "Annee"])["DATE_ARRETE"].idxmax()]

data_VE_annee_dep[data_VE_annee_dep["LIBGEO"]=="CHARTRES"]

data_VE_annee_dep.to_csv("Projet/data/data_VE/data_VE.csv", index=False)

data_VE_annee_dep.info()

data_VE=data_VE_annee_dep[["CODGEO", "LIBGEO", "departement", "region", "Annee", "NB_VP_RECHARGEABLES_EL", "NB_VP_RECHARGEABLES_GAZ", "NB_VP"]]

data_VE[data_VE["LIBGEO"]=="BAZIEN"]

data_VE.to_csv("Projet/data/data_VE/data_VE_annee.csv", index=False)
...
data_VE_annee_region.to_csv("Projet/data/data_VE/data_VE_annee_region.csv", header=True)
...
data_VE_annee_dep.head(20)

data_VE_annee_dep.to_csv("Projet/data/data_VE/data_VE_annee_dep.csv", header=True)